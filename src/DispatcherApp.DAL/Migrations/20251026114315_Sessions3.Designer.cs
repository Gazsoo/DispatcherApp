...
namespace DispatcherApp.DAL.Migrations
{
    ...
    [Migration("20251026114315_Sessions3")]
    partial class Sessions3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DispatcherSessionIdentityUser", b =>
                {
                    b.Property<int>("DispatcherSessionId")
                        .HasColumnType("int");

                    b.Property<string>("ParticipantsId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("DispatcherSessionId", "ParticipantsId");

                    b.HasIndex("ParticipantsId");

                    b.ToTable("DispatcherSessionIdentityUser");
                });
            ...
            modelBuilder.Entity("DispatcherSessionIdentityUser", b =>
                {
                    b.HasOne("DispatcherApp.Common.Entities.DispatcherSession", null)
                        .WithMany()
                        .HasForeignKey("DispatcherSessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
